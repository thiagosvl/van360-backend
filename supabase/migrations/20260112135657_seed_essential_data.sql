...
('ac17996e-5522-43f9-949a-41353542a53b', NULL, 'base', 'Essencial', 'essencial', 'Profissionalize sua gestão e organize quantos passageiros quiser.', 2, true, 0, 0, 89.90, 47.00, true, true, '2025-10-30 15:08:48.988941+00', 7, '["Passageiros e Cadastros ILIMITADOS", "Link de Cadastro: envie para os pais e eles preenchem por você", "Controle de Gastos: saiba seu lucro real (Combustível/Manutenção)", "Relatórios Financeiros e de Inadimplência", "Suporte prioritário via WhatsApp"]'),
...
INSERT INTO public.planos (id, parent_id, tipo, nome, slug, descricao_curta, ordem_exibicao, ativo, limite_passageiros, franquia_cobrancas_mes, preco, preco_promocional, promocao_ativa, permite_cobrancas, created_at, trial_days, beneficios)
VALUES
('1c632a37-8f6a-4fa1-a734-c12e1ddaf44d', 'e0961539-3186-43e8-adac-4f009720d428', 'sub', 'Até 25 Cobranças', 'completo_25', NULL, 1, true, 0, 25, 107.00, 87.00, true, true, '2025-10-30 15:13:14.772511+00', 0, '[]'),
('21a70496-9769-48dd-857e-98726ab81292', 'e0961539-3186-43e8-adac-4f009720d428', 'sub', 'Até 50 Cobranças', 'completo_50', NULL, 2, true, 0, 60, 147.00, 127.00, true, true, '2025-10-30 15:13:14.772511+00', 0, '[]'),
('484db34f-23c3-4731-a11c-e85074ce1b23', 'e0961539-3186-43e8-adac-4f009720d428', 'sub', 'Até 90 Cobranças', 'completo_90', NULL, 3, true, 0, 90, 227.00, 197.00, true, true, '2025-10-30 15:13:14.772511+00', 0, '[]')
ON CONFLICT (id) DO UPDATE SET
    nome = EXCLUDED.nome,
